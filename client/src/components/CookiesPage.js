  ...
  return (
    <div className="Page Page--cookies">
      ...
      <Container>
        <Pane>
        <h2>Cookie Policy</h2>
        <p>We use cookies to help improve your experience of <a href="http://gilitrip.com">http://gilitrip.com</a>. This cookie policy is part of Gili Hidup Bebas' privacy policy, and covers the use of cookies between your device and our site.</p>
        <p>If you don’t wish to accept cookies from us, you should instruct your browser to refuse cookies from <a href="http://gilitrip.com">http://gilitrip.com</a>, with the understanding that we may be unable to provide you with some of your desired content and services.</p>
