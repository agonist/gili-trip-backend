  ...
  return (
    <div className="Page Page--privacy">
      ...
      <Container>
        ...
        <p>Your privacy is important to us. It is Gili Hidup Bebas' policy to respect your privacy regarding any information we may collect from you across our website, <a href="http://gilitrip.com">http://gilitrip.com</a>, and other sites we own and operate.</p>
        ...
        <p>This privacy policy only covers Gili Hidup Bebas' own collecting and handling of data. We only work with partners, affiliates and third-party providers whose privacy policies align with ours, however we cannot accept responsibility or liability for their respective privacy practices.</p>
