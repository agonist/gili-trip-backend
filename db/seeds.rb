...
if Rails.env.development?
  ...
  Trip.create(name: 'Gili Trawangan to Bali', from_id: 3, to_id: 1, operator_id: 2, status: 'available', price: '35', currency: "$", departure_time:  "14:45", arrival_time:  "16:00", duration: '90', vehicle_id: 1, high_season: true, high_season_percentage_multiplier: 5)
